...
internal class AppState {
    ...
    internal var ttsState: TTSState = .idle
    internal var currentlySpeaking: String = ""
    internal var ttsProgress: Double = 0.0
    internal var showTTSNotch: Bool = false
...
internal enum TTSState: Equatable {
    case idle
    case generating
    case speaking
    case paused
